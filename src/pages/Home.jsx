...
export default function Home() {
  ...
  <Saludo nombre="Facu" />
      ...
      <div className="relative w-full h-52 md:h-64 overflow-hidden rounded-xl shadow-lg mx-auto mt-4">
        ...
        <div className={`relative z-10 h-full flex flex-col items-center justify-center text-center px-4 transition-opacity duration-500 ${fade ? "opacity-100" : "opacity-0"}`}>
          ...
          <button
            ...
            className="mt-3 bg-white text-purple-700 font-bold py-1.5 px-6 rounded-full shadow-lg hover:bg-purple-100 transition transform hover:scale-105 flex items-center gap-2"
          >
            <FaLightbulb />
      ...
      <div className="flex-1 w-full max-w-md mx-auto px-4 py-6 space-y-4">
        <div className="grid grid-cols-1 gap-4">
          ...
          <button
            ...
            className="bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-xl p-4 flex items-center gap-4 shadow-md hover:scale-[1.03] transition"
          >
          ...
          <button
            ...
            className="bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-xl p-4 flex items-center gap-4 shadow-md hover:scale-[1.03] transition"
          >
          ...
          <button
            ...
            className="bg-gradient-to-r from-teal-500 to-teal-700 text-white rounded-xl p-4 flex items-center gap-4 shadow-md hover:scale-[1.03] transition"
          >
          ...
          <button
            ...
            className="bg-gradient-to-r from-yellow-400 to-yellow-500 text-slate-900 rounded-xl p-4 flex items-center gap-4 shadow-md hover:scale-[1.03] transition"
          >
      ...
      <div className="text-center text-sm text-slate-400 mt-8 px-6 mb-20">
